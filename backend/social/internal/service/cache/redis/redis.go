...
func (r *RedisCache) Load(ctxInitial context.Context, key string, loadFunc LoadFunc) (any, error) {
	ctx, span := otel.Tracer("default").Start(ctxInitial, "load redis")
	defer span.End()
...
func (r *RedisCache) GetOrLoad(ctxInitial context.Context, key string, loadFunc LoadFunc) (any, error) {
	ctx, span := otel.Tracer("default").Start(ctxInitial, "get or load redis")
	defer span.End()
