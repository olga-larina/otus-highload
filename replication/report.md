...
## Правки в коде
Для работы с пулами была использована библиотека `github.com/jackc/pgx/v5/pgxpool` (которая оказалась более эффективной). Максимальное количество соединений задано равным 80 (`maxConns` в [конфигах](../backend/configs/server_config.yaml)).    
